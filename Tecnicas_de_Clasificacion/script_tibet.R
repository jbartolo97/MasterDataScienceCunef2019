...
craneos <- read.table("C:/Users/jbart/OneDrive/Escritorio/CUNEF/Tecnicas de Clasificación/Clase 1/craneos.txt", header=FALSE, sep="", na.strings="NA", dec=".", 
                      strip.white=TRUE)
setwd("C:/DAT/JESUS/UNIVERSIDAD/MASTER CUNEF/EJERCICIOS CLASE/DISCRIMINANTE TIBET")
...
m1 <- apply(craneos[Tipo==1,-6],2,mean) #el subindice 2 significa medias por columnas, 1 significa por filas
...
#la tasa de error se obtiene a traves de la matriz de confusión, (6/32) en este caso.
