setwd("C:/DAT/JESUS/UNIVERSIDAD/MASTER CUNEF/ARBOLES ECOLI")
# Leemos la base de datos

ecoli.df = read.csv("ecoli.txt", header=FALSE, sep="")
head(ecoli.df)
fix(ecoli.df)
...
ecoli.tree1 = tree(class ~ mcg + gvh + lip + chg + aac + alm1 + alm2,
                     data = ecoli.df)
summary(ecoli.tree1)
